...
export function TVSchedule() {
  ...
  const maxViewership = useMemo(() => getMaxViewership(), []);
  const [showViewershipGraph, setShowViewershipGraph] = useState(false);
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch
                id="viewership-graph"
                checked={showViewershipGraph}
                onCheckedChange={setShowViewershipGraph}
              />
              <label
                htmlFor="viewership-graph"
              ...
              >
                <div className="relative h-full">
                  {Array.from({ length: HOURS_IN_DAY + 1 }).map((_, index) => (
                    ...
                    >
                      <span className="absolute left-2 top-4 text-sm font-bold text-foreground">
                        {`${
