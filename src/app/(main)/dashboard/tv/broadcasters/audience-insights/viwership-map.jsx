...
const ViewershipMap = ({ data }) => {
  ...
  const getColorScale = (value, min, max) => {
    ...
    // Interpolate between light blue (BBDEFB) and dark blue (1565C0)
    const r = Math.round(187 - ratio * (187 - 21)); // 187 -> 21
    const g = Math.round(222 - ratio * (222 - 101)); // 222 -> 101
    const b = Math.round(251 - ratio * (251 - 192)); // 251 -> 192
    return `rgb(${r}, ${g}, ${b})`;
  };
    ...
    <div className="relative w-full h-fit">
      ...
      {data.map((region) => {
        ...
        const labelPositions = {
          Bagmati: { x: 888.40782, y: 412.68113 },
          Gandaki: { x: 723.06532, y: 299.24713 },
          Lumbini: { x: 522.95532, y: 428.99213 },
          Karnali: { x: 259.65032, y: 257.89463 },
          Janakpur: { x: 1062.32282, y: 480.75613 },
        };
        ...
        return (
          ...
          >
            ...
            <div>{(region.viewers / 1000).toFixed(0)}k</div>
          </div>
        );
      })}
    </div>
